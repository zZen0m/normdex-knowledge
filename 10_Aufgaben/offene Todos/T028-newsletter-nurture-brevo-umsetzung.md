...
- [ ] Automations-Workflow end-to-end testen (Wegwerf-Adresse in Liste 3, Wartezeiten temporär verkürzen, danach zurücksetzen). **Hinweis 2026-06-24:** Der eigentliche Automation-Versand der Nurture-Mail wurde beim Dev-Test nicht beobachtet (nur die T019-Sofort-Mail kam zweimal an), die Vorlage selbst lässt sich nicht per Brevo „Send Test"-API einzeln prüfen (404, da Automations-Workflow-Schritt statt eigenständiges Transaktions-Template). Dieser Punkt bleibt offen.
