...
- Abgeschlossen am 2026-04-27.
- Guideline angelegt: `02_App/Toast-Benachrichtigungen.md`.
- Zentraler Helper eingeführt: `apps/frontend/src/lib/notify.tsx`.
- Standard-Toast-Aufrufe im Frontend auf `notify` migriert.
